...
export const ui = {
  en: {
    ...
    'projects.lead':
      'Five repositories, at honestly different stages of maturity. Status labels below are not marketing — they say what you can actually rely on today.',
  ...
  zh: {
    ...
    'projects.title': '项目',
    'projects.lead':
      '五个仓库，成熟度确实各不相同。下面的状态标签不是宣传语，它说明的是今天你真正可以依赖到什么程度。',
    'projects.repo': '仓库',
